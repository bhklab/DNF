### Determines the number of drugs that will be gained by 
### replacing the drugs that Nehme gave us with their pert_iname
### (as opposed to having drug names) prior to intersecting the sensitivity data with L1000.
badchars <- "[\xb5]|[\n]|[,]|[;]|[:]|[-]|[+]|[*]|[%]|[$]|[#]|[{]|[}]|[[]|[]]|[|]|[\\^]|[/]|[\\]|[.]|[_]|[ ]"
