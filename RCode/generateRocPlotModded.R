...
generateRocPlotModded <- function(allPairs, d1Name, d2Name="lincs", benchName) {
    ...
    legend(0.5,0.4,c(aucLegIntegr, aucLegStr, aucLegSen, aucLegPer, rand), border="white", cex=0.75,
           box.col = "white",fill=c("black","#d7191c","#41ab5d","#2b83ba", "gray"))
