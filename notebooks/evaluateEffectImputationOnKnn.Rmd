...
for (i in imputation.sizes) {
    ...
    print(paste(i, "Sensitivity drugs imputed, accuracy:", sum(accuracy) / length(accuracy), sep=" "))
}
```
...
for (i in imputation.sizes) {
    ...
    print(paste(i, "Structure drugs imputed, accuracy:", sum(accuracy) / length(accuracy), sep=" "))
}
```
...
for (i in imputation.sizes) {
    ...
    print(paste(i, "Perturbation drugs imputed, accuracy:", sum(accuracy) / length(accuracy), sep=" "))
}
```
...
```{r}
set.seed(981)
imputation.sizes <- c(0, 10, 25, 50, 100, 125, 150, 175, 200, length(benchmark.drugs))
