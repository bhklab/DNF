---
title: "Compare Old vs New Perturbation Signatures On KNN Performance - RV"
output: html_notebook
---

## Description

The purpose of this notebook is to see the if there is a gain in accuracy when using the new pert singatures that were correlated using the RV coefficient as opposed to the old pert signatures.
...
pert.data.new <- PerturbationDataFlexibleCustomSig("Data/pert_sigs_6_hour/pert_rv_correlations.rds")
...
print(paste("Accuracy Using New Sigs:", sum(accuracy) / length(accuracy), sep=" "))
```

## Effect Measured on CTRPv2, CLUE, and CHEMBL

We really just need to obtain the drug targets for the combination of the 3 different datasets, then evaluate performance using that target info
